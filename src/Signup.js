                            ...
                            <div>{!addph &&
                                <>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="password" id="confirmpassword" value={state1.confirmpassword} name="confirmpassword" className="form-control" placeholder="*****" onChange={HandleChange}  required
                                            minLength={6}
                                            maxLength={6} />
                                    </div>
